...
*/
function calcularBasicas(valor1, valor2, operador){
        switch (operador){
            case "+":
            ...
            case "/":
                ...
                break;
            case "%":
                return obtenerResto(valor1, valor2);
                break;
            default:     
...
console.log("El resultado de la operación "+ operador+"\nentre "+valor1+" y "+valor2+"\nes:  "
    +calcularBasicas(valor1, valor2, operador));
...
/*
    ...
    === //Exactamente igual que (1 y "1" no son iguales, pero 1 es exactamente igual a 1 
        y "1" es exactamente igual a  "1"). Este operador compara el valor y el TIPO del valor.
    ...
    Atención: No mezclar '=' y '==' ó '===' porque tienen distintos significados.
         ...
         '===' significa preguntar si es "exactamente igual a". miVariable === 1 es verdadero 
         si miVariable es 1, y falso si es cualquier otra cosa distinta de 1.
...
//
// Si tenemos un operador igual a '+', llamamos la función 'sumar' con nuestros números
// (las variables del paso 2).
